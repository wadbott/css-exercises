...
### Self Check
- Do the odd numbered `p` elements share a class? yep
- Do the even numbered `div` elements have unique IDs? yep
- Does the Number 3 element have multiple classes? yep
